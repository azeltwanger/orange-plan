...
export default function FinancialPlan() {
  ...
  useEffect(() => {
    const calculateMaxSpending = () => {
      ...
      // For Dynamic % and 4%: calculate first-year withdrawal in today's dollars
      if (withdrawalStrategy === 'dynamic' || withdrawalStrategy === '4percent') {
